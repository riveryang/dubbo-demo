...
public class HelloWorldRunner implements Runnable {
	...
	public void run() {
		...
		final HelloWorldService service = (HelloWorldService) context.getBean("helloWorldProxyService");
		if (service == null) {
			throw new IllegalArgumentException("Not found service: helloWorldProxyService");
		}
